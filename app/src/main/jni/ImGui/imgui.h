...
namespace ImGui
{
    ...
    IMGUI_API void          SetBlackGoldTheme(ImGuiStyle* dst = NULL);
    IMGUI_API void          SetDarkGrayTheme(ImGuiStyle* dst = NULL);
    IMGUI_API void          SetSoftDarkRedTheme(ImGuiStyle* dst = NULL);
    IMGUI_API void          SetClassicSteamHalfLifeTheme(ImGuiStyle* dst = NULL);
    IMGUI_API void          SetAnotherDarkThemeReally(ImGuiStyle* dst = NULL);
    IMGUI_API void          SetDarkGreenBlueTheme(ImGuiStyle* dst = NULL);
    IMGUI_API void          SetDarkRedTheme(ImGuiStyle* dst = NULL);
    IMGUI_API void          SetCorporateGrayTheme(ImGuiStyle* dst = NULL);
    IMGUI_API void          SetYetAnotherDarkTheme(ImGuiStyle* dst = NULL);
    IMGUI_API void          SetYesAnotherDarkTheme(ImGuiStyle* dst = NULL);
