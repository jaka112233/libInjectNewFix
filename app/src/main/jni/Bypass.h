...
void initByps() {
	...
	Tools::Hook((void *) (uintptr_t)Il2CppGetMethodOffset(OBFUSCATE("Assembly-CSharp.dll"), OBFUSCATE("RGScript.Util"), OBFUSCATE("RootAndSimulatorDetecter") , OBFUSCATE("IsRoot"), 0), (void *) Bypass_AntiCheat_, (void **) &_Bypass_AntiCheat_);
	Tools::Hook((void *) (uintptr_t)Il2CppGetMethodOffset(OBFUSCATE("Assembly-CSharp.dll"), OBFUSCATE("RGScript.Util"), OBFUSCATE("RootAndSimulatorDetecter") , OBFUSCATE("IsSimulator"), 0), (void *) Bypass_AntiCheat_, (void **) &_Bypass_AntiCheat_);
